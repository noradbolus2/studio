...
const examDatabase: Record<string, { pattern: string; syllabus_overview: string; eligibility: string }> = {
  'neet ug': {
    pattern: "For 2025, the NEET (UG) exam pattern consists of 200 multiple-choice questions from Physics, Chemistry, and Biology (Botany & Zoology), out of which 180 questions need to be answered. The total marks are 720, and the duration is 3 hours and 20 minutes. Each subject has two sections: Section A with 35 compulsory questions and Section B with 15 questions, out of which any 10 must be attempted. Marking scheme: +4 for correct, -1 for incorrect.",
