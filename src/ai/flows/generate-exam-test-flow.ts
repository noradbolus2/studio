...
3.  **Specialized and Super-Specialty Exams (CRITICAL FOR ACCURACY & COMPLEXITY):**
    ...
    *   **AVOID GENERAL KNOWLEDGE OR FOUNDATIONAL QUESTIONS.** For example:
        ...
        *   If "UPSC CSE Mains Optional - History", questions must require deep analytical and historical interpretation skills on niche topics within the optional syllabus, not just factual recall suitable for GS Paper 1. Questions should demand critical evaluation and essay-style depth, even if presented in MCQ format for this generator's purpose.
