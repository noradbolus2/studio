        ...
        <CardContent className="p-4 flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-4 text-sm text-muted-foreground mt-2">
              <span className="flex items-center gap-1"><Star className="h-4 w-4 text-yellow-400 fill-yellow-400" /> {mockTeacherProfile.rating}/5.0 ({mockTeacherProfile.reviewCount/1000}k reviews)</span>
              <span className="flex items-center gap-1"><MapPin className="h-4 w-4" /> {mockTeacherProfile.location}</span>
            </div>
             <p className="text-sm text-muted-foreground mt-1">{mockTeacherProfile.institution}</p>
          </div>
