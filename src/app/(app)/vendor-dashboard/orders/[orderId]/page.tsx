  ...
  if (!order) {
    return (
      <div className="space-y-6 text-center">
        ...
        <Button variant="outline" onClick={() => router.push('/vendor-dashboard/orders')}>
          <ArrowLeft className="mr-2 h-4 w-4" /> <BilingualText en="Back to Orders" hi="आदेश पर वापस" />
        </Button>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button variant="outline" size="sm" onClick={() => router.push('/vendor-dashboard/orders')}>
          <ArrowLeft className="mr-2 h-4 w-4" />
          <BilingualText en="Back to Orders" hi="आदेश पर वापस" />
        </Button>
      </div>
